...
use crate::theme::types::{Rgb, ThemeMode, ThemeOps};
...
pub(crate) struct ThemePresetBuilder {
    ...
    pub(super) panel_background: Option<Rgb>,
    pub(super) code_background: Option<Rgb>,
    pub(super) text_secondary: Option<Rgb>,
    pub(super) success: Option<Rgb>,
    pub(super) warning: Option<Rgb>,
    pub(super) error: Option<Rgb>,
    pub(super) border: Option<Rgb>,
    pub(super) selection: Option<Rgb>,
}
