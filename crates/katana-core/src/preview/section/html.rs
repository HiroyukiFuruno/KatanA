use crate::html::{HtmlNode, HtmlParser};
use crate::preview::types::HtmlPreviewOps;
use regex::Regex;

impl HtmlPreviewOps {
    pub fn parse_html(html: &str, base_dir: &std::path::Path) -> String {
        let parser = HtmlParser::new(base_dir);
