...
pub struct UpdateMessages {
    ...
    pub update_check_error_network_unreachable: String,
    pub update_check_error_network_timed_out: String,
    pub update_check_error_server_status: String,
    pub update_check_error_proxy_failed: String,
    pub update_check_error_invalid_payload: String,
    pub update_check_error_unknown: String,
