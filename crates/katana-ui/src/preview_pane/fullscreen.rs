...
pub(crate) fn render_slideshow_modal(
    ...
    let bg_color = ctx
        ...
        .map_or(crate::theme_bridge::WHITE, |tc| {
            crate::theme_bridge::rgb_to_color32(tc.preview.background)
        });
            ...
            ui.scope_builder(egui::UiBuilder::new().max_rect(content_rect), |ui| {
                ...
                if opacity > SLIDESHOW_OPACITY_MIN {
                    ui.put(control_rect, |ui: &mut egui::Ui| {
                        ...
                        let mut stroke_color = ui.visuals().widgets.noninteractive.bg_stroke.color;
                        ...
                        frame
                            .show(ui, |ui| {
                                ui.horizontal_centered(|ui| {
                                    ...
                                    ui.label(
                                        egui::RichText::new(page_text).strong().color(icon_color),
                                    );
                ...
                egui::Button::image(
                    Icon::CloseModal.image(crate::icon::IconSize::Large).tint(
                        ...
                        .map_or(crate::theme_bridge::BLACK, |tc| {
                            crate::theme_bridge::rgb_to_color32(tc.preview.text)
                        }),
                    ),
                )
