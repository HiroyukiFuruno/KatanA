...
macro_rules! impl_icon_pack_match {
    ($dir:expr, $icon:expr) => {
        match $icon {
            ...
            crate::icon::Icon::FilePlus => Some(include_bytes!(concat!("../../../../../assets/icons/", $dir, "/", "files/file_plus", ".svg"))),
            ...
            crate::icon::Icon::FolderPlus => Some(include_bytes!(concat!("../../../../../assets/icons/", $dir, "/", "files/folder_plus", ".svg"))),
