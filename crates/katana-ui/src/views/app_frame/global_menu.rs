    ...
    pub(crate) fn show(self, ui: &mut egui::Ui) {
        ...
        macro_rules! btn {
            ($ui:expr, $id:expr, $label:expr, $action:expr) => {
                if $ui.add_enabled(is_avail($id, &app.state), egui::Button::new($label)).clicked() { app.pending_action = $action; $ui.close_menu(); }
            };
            ($ui:expr, $id:expr, $label:expr, $shortcut:expr, $action:expr) => {
                if $ui.add_enabled(is_avail($id, &app.state), egui::Button::new($label).shortcut_text(crate::os_command::OsCommandOps::get($shortcut))).clicked() { app.pending_action = $action; $ui.close_menu(); }
            };
        }
            ...
            egui::menu::bar(ui, |ui| {
                ...
                crate::widgets::MenuButtonOps::show(ui, &i18n.menu.settings, |ui| {
                    ...
                    crate::widgets::MenuButtonOps::show(ui, &i18n.menu.language, |ui| {
                        ...
                        #[rustfmt::skip]
                        let langs = [
                            ("en", &i18n.menu.language_en), ("ja", &i18n.menu.language_ja),
                            ("zh-CN", &i18n.menu.language_zh_cn), ("zh-TW", &i18n.menu.language_zh_tw),
                            ("ko", &i18n.menu.language_ko), ("pt", &i18n.menu.language_pt),
                            ("fr", &i18n.menu.language_fr), ("de", &i18n.menu.language_de),
                            ("es", &i18n.menu.language_es), ("it", &i18n.menu.language_it),
                        ];
