...
MERMAID_FIXTURES := env_var_or_default("MERMAID_FIXTURES", "assets/fixtures/mermaid_all")
MERMAID_REFERENCE_DIR := env_var_or_default("MERMAID_REFERENCE_DIR", MERMAID_FIXTURES + "/official")
MERMAID_KATANA_DIR := env_var_or_default("MERMAID_KATANA_DIR", "tmp/mermaid-katana-rendered")
MERMAID_REFERENCE_BROWSER_DIR := env_var_or_default("MERMAID_REFERENCE_BROWSER_DIR", "tmp/mermaid-reference-browser")
MERMAID_KATANA_BROWSER_DIR := env_var_or_default("MERMAID_KATANA_BROWSER_DIR", "tmp/mermaid-katana-browser")
MERMAID_SAMPLE := env_var_or_default("MERMAID_SAMPLE", "assets/fixtures/mermaid.md")
MERMAID_SAMPLE_FIXTURES_DIR := env_var_or_default("MERMAID_SAMPLE_FIXTURES_DIR", "tmp/mermaid-sample-fixtures")
MERMAID_SAMPLE_REFERENCE_DIR := env_var_or_default("MERMAID_SAMPLE_REFERENCE_DIR", "tmp/mermaid-sample-official")
MERMAID_SAMPLE_KATANA_DIR := env_var_or_default("MERMAID_SAMPLE_KATANA_DIR", "tmp/mermaid-sample-katana")
MERMAID_SAMPLE_REFERENCE_BROWSER_DIR := env_var_or_default("MERMAID_SAMPLE_REFERENCE_BROWSER_DIR", "tmp/mermaid-sample-official-browser")
MERMAID_SAMPLE_KATANA_BROWSER_DIR := env_var_or_default("MERMAID_SAMPLE_KATANA_BROWSER_DIR", "tmp/mermaid-sample-katana-browser")
MERMAID_SAMPLE_COMPARISON_DIR := env_var_or_default("MERMAID_SAMPLE_COMPARISON_DIR", "tmp/mermaid-sample-comparison")
