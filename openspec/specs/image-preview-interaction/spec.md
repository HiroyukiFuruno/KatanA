# image-preview-interaction Specification

## Purpose

Define stable fullscreen image navigation and theme-independent overlay controls
so raster and SVG previews remain operable without changing image dimensions.
