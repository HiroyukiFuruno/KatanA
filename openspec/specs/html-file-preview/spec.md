...
KatanA allows users to open static `.html` and `.htm` source documents and preview supported HTML content in the native preview pane without adding a browser runtime.
