...
- [ ] `v0.23.0` の local provider 設定と availability 判定が利用可能であること
...
- [ ] 4.6 Execute release tagging and creation using `.agents/skills/release_workflow/SKILL.md` for `0.24.0`
