...
- **標準（Base）ブランチ**: `v0-22-5-file-operations-improvements` またはリリース用統合ブランチ（例: `release/vX.Y.Z`）
- **作業ブランチ**: 標準は `v0-22-5-file-operations-improvements-task-x`、リリース用は `feature/vX.Y.Z-task-x` (xはタスク番号)
