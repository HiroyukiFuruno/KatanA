...
`katana-diagram-renderer` はMermaid、Draw.io、PlantUML、mathなどの外部描画を担う。
...
- DoD: Mermaid、Draw.io、PlantUML、mathなどの外部描画を担う。
...
- DoR: KMM、KDV、KLE、KDR、KCF、KUWのpublic contractが利用可能である。
