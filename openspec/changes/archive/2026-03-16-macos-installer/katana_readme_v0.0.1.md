...
**Katana Desktop** is a fast, lightweight Markdown workspace designed for technical documentation and Spec-Driven Development (SDD).
...
Katana focuses on enabling developers to work efficiently with:
