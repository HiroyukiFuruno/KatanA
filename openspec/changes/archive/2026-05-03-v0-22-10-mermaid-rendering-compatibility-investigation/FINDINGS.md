...
just T=cache_file_path_uses_rust_managed_svg_profile test-specific
just T=mermaid_cache_key_ignores_legacy_renderer_env test-specific
just T=mermaid_runtime_is_always_rust_managed_svg test-specific
just build-release
```
