...
- **標準（Base）ブランチ**: `v0-22-7-toc-improvements`
- **作業ブランチ**: 標準は `v0-22-7-toc-improvements-task-x` (x はタスク番号)
...
- [ ] 3.6 Create `release/v0.22.7` branch from master
- [ ] 3.7 Run `make release VERSION=0.22.7` and update CHANGELOG (`changelog-writing` skill)
- [ ] 3.8 Create PR from `release/v0.22.7` targeting `master` — Ensure `Release Readiness` CI passes
