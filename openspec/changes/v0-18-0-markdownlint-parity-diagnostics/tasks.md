...
- [ ] 4.3 docs と status copy を v0.18.0 の contract に合わせて更新する
...
- [ ] 5.6 Execute release tagging and creation using `.agents/skills/release_workflow/SKILL.md` for `0.18.0`
