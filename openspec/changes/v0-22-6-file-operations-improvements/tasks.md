...
- [ ] 6.7 Create `release/v0.22.6` branch from master
- [ ] 6.8 Run `make release VERSION=0.22.6` and update CHANGELOG (`changelog-writing` skill)
- [ ] 6.9 Create PR from `release/v0.22.6` targeting `master` — Ensure `Release Readiness` CI passes
