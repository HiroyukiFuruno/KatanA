...
- [ ] `v0.20.0` の command inventory と `v0.21.0` の shortcut schema が利用可能であること
...
- [ ] 4.6 Execute release tagging and creation using `.agents/skills/release_workflow/SKILL.md` for `0.22.0`
