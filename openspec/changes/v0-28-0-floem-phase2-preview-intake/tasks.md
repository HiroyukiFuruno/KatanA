# Tasks: v0.28.0 Floem Phase 2 intake（preview）— KatanA
...
- [ ] v0.27.0（Phase 1: editor + chat input intake）が完了している
...
- [ ] 2.3 残る egui 依存（chrome のみ）を記録する（v0.29.0 の対象）
...
- [ ] 3.1 `release/v0.28.0` ブランチから PR を作成し master へ merge する
