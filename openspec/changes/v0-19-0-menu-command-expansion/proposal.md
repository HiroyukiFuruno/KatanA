...
現在の menu surface は macOS native menu と一部 command palette に分散しており、File / View / Help の到達性と command coverage が十分に整理されていない。`v0.20.0` の shortcut customization を成立させるには、その前に user-facing command inventory と menu grouping を正規化する必要がある。
...
- `v0.20.0` の shortcut customization の prerequisite になる
