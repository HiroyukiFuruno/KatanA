...
v0.28.0（Floem Phase 3・chrome 完全除去 = egui / eframe ゼロ）完了後、v1.0.0 として公式リリースするための品質確認・polish を行う。egui 時代の制約（IME 破損・カラー絵文字欠如・vendor パッチ）がなくなった状態で、ユーザー体験の最終仕上げを行う。
...
- DoR: v0.28.0（Floem Phase 3・chrome 完全除去 = egui / eframe ゼロ）完了後
- 全クレートの結合テスト
