...
- [ ] P1 KMMのmetadata/display DTO方針が利用可能である
- [ ] KMM/kdp/kleで必要になる共通UI部品候補が列挙されている

### Tasks

- [ ] 1.1 `katana-ui/src/widgets` の分離候補を棚卸しする
- [ ] 1.2 KMM metadata表示、unresolved表示、copy/edit actionを初期候補にする
...
- [ ] KMM文書モデルやmetadata schemaをwidget repoへ持たせない方針が明確である
- [ ] KMMより先にUI表示型を固定しない方針が明確である
