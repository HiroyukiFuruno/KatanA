...
途中で外部アプリへ切り替える必要がある。KDV `v0.5.1` のbackend-neutral multi-format
...
- KDV `v0.5.1` 公開後にcrates.io dependencyとして取り込み、path / git dependencyを残さない
...
- `Cargo.toml` / `Cargo.lock`: 公開済み `katana-document-viewer 0.5.1`
