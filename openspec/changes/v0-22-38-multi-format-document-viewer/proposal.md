...
途中で外部アプリへ切り替える必要がある。KDV `v0.4.0` で計画するmulti-format
...
- KDV `v0.4.x` 公開後にcrates.io dependencyとして取り込み、path / git dependencyを残さない
...
- `Cargo.toml` / `Cargo.lock`: 公開済み `katana-document-viewer 0.4.x`
