...
- **HTMLファイルのプレビュー**: `.html` / `.htm` ファイルを直接プレビューできるようになりました。見出し、段落、リンク、画像、details セクション、テーブルなど、一般的な静的HTML文書を確認できます。
...
- **プレビューの安定性向上**: 文書プレビューと描画動作の自動検証を拡充し、リリース時の安定性を高めました。
