...
expect_accept 0.22.36 0.22.35 $'## [0.22.36]\n## [0.22.35]'
expect_reject 0.22.35 0.22.35 $'## [0.22.35]\n## [0.22.34]'
expect_reject 0.22.37 0.22.35 $'## [0.22.37]\n## [0.22.36]'
expect_reject 0.29.0 0.22.35 $'## [0.29.0]\n## [0.22.35]'
expect_reject 0.23.0 0.22.35 $'## [0.23.0]\n## [0.22.35]'
expect_reject 1.0.0 0.22.35 $'## [1.0.0]\n## [0.22.35]'
expect_reject 0.22.36 0.22.35 $'## [0.22.36]\n## [0.22.34]'

[[ "$(bash "$BRANCH_VERSION_GUARD" release/v0.22.36)" == "0.22.36" ]]
[[ "$(bash "$BRANCH_VERSION_GUARD" release/v0.22.36-html-viewer)" == "0.22.36" ]]
